...
!
  ...
  real(kind=8),  save,  target                 :: total_carbon
  real(kind=8),  save,  target                 :: valDIC
  real(kind=8),  save,  target                 :: valDOC
  real(kind=8),  save,  target                 :: valPhyC
  real(kind=8),  save,  target                 :: valDetC
  real(kind=8),  save,  target                 :: valHetC
  real(kind=8),  save,  target                 :: valDiaC
  real(kind=8),  save,  target                 :: valPhyCalc
  real(kind=8),  save,  target                 :: valDetCalc
  real(kind=8),  save,  target                 :: valDSi
  real(kind=8),  save,  target                 :: valDiaSi
  real(kind=8),  save,  target                 :: valDetSi
  real(kind=8),  save,  target                 :: valDetz2Si
  real(kind=8),  save,  target                 :: valBenSi

  real(kind=8),  save,  target                 :: total_silicate
  ...
  real(kind=8)                                 :: ctime !current time in seconds from the beginning of the year
  integer                                       :: row 
