...
SUBROUTINE derivnum (dh_dx, dpco2_dx, dfco2_dx, dco2_dx, dhco3_dx,                   &
                     ...
                     temp, sal, alk, dic, sil, phos, Patm, depth, lat, derivar,   &
  ...
  END SELECT
    ...
    IF (deriv_K) THEN
        ...
        call vars_pertK(ph(1), pco2(1), fco2(1), co2(1), hco3(1), co3(1),      &
                        OmegaA(1), OmegaC(1),                                          &
                        atemp, asal, aalk, adic, asil, aphos, aPatm, adepth, alat,       &
                        var_index, -abs_delta,                                             &
       ...
       ENDIF
        ...
        SELECT CASE (var_index)
            ...
            CASE (8)
                ...
                input_value = 0.0002414d0 * (sal  / 1.80655d0) / 10.811d0
        ...
        ainput1 = input_value - abs_delta
        ainput2 = input_value + abs_delta
        ...
        SELECT CASE (var_index)
            CASE (1)
                call vars(ph(1), pco2(1), fco2(1), co2(1), hco3(1), co3(1),               &
                                ...
                                atemp, asal, ainput1, adic, asil, aphos, aPatm, adepth, alat,       &
                ...
                call vars(ph(2), pco2(2), fco2(2), co2(2), hco3(2), co3(2),               &
                                ...
                                atemp, asal, ainput2, adic, asil, aphos, aPatm, adepth, alat,       &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon               ) 
            CASE (2)
                call vars(ph(1), pco2(1), fco2(1), co2(1), hco3(1), co3(1),               &
                                OmegaA(1), OmegaC(1), BetaD, rhoSW, p, tempis,                    &
                                atemp, asal, aalk, ainput1, asil, aphos, aPatm, adepth, alat,       &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon, verbose=.false. ) 
                call vars(ph(2), pco2(2), fco2(2), co2(2), hco3(2), co3(2),               &
                                OmegaA(2), OmegaC(2), BetaD, rhoSW, p, tempis,                    &
                                atemp, asal, aalk, ainput2, asil, aphos, aPatm, adepth, alat,       &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon               )
            CASE (3)
                call vars(ph(1), pco2(1), fco2(1), co2(1), hco3(1), co3(1),               &
                                OmegaA(1), OmegaC(1), BetaD, rhoSW, p, tempis,                    &
                                atemp, asal, aalk, adic, asil, ainput1, aPatm, adepth, alat,        &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon, verbose=.false. )
                call vars(ph(2), pco2(2), fco2(2), co2(2), hco3(2), co3(2),               &
                                OmegaA(2), OmegaC(2), BetaD, rhoSW, p, tempis,                    &
                                atemp, asal, aalk, adic, asil, ainput2, aPatm, adepth, alat,        &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon             ) 
            CASE (4)
                call vars(ph(1), pco2(1), fco2(1), co2(1), hco3(1), co3(1),               &
                                OmegaA(1), OmegaC(1), BetaD, rhoSW, p, tempis,                    &
                                atemp, asal, aalk, adic, ainput1, aphos, aPatm, adepth, alat,      &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon, verbose=.false. )
                call vars(ph(2), pco2(2), fco2(2), co2(2), hco3(2), co3(2),               &
                                OmegaA(2), OmegaC(2), BetaD, rhoSW, p, tempis,                    &
                                atemp, asal, aalk, adic, ainput2, aphos, aPatm, adepth, alat,       &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon             ) 
            CASE (5)
                call vars(ph(1), pco2(1), fco2(1), co2(1), hco3(1), co3(1),               &
                                OmegaA(1), OmegaC(1), BetaD, rhoSW, p, tempis,                    &
                                ainput1, asal, aalk, adic, asil, aphos, aPatm, adepth, alat,        &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon, verbose=.false. )
                call vars(ph(2), pco2(2), fco2(2), co2(2), hco3(2), co3(2),               &
                                OmegaA(2), OmegaC(2), BetaD, rhoSW, p, tempis,                    &
                                ainput2, asal, aalk, adic, asil, aphos, aPatm, adepth, alat,        &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon             ) 
            CASE (6)
                call vars(ph(1), pco2(1), fco2(1), co2(1), hco3(1), co3(1),               &
                                OmegaA(1), OmegaC(1), BetaD, rhoSW, p, tempis,                    &
                                atemp, ainput1, aalk, adic, asil, aphos, aPatm, adepth, alat,       &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon, verbose=.false. )
                call vars(ph(2), pco2(2), fco2(2), co2(2), hco3(2), co3(2),               &
                                OmegaA(2), OmegaC(2), BetaD, rhoSW, p, tempis,                    &
                                atemp, ainput2, aalk, adic, asil, aphos, aPatm, adepth, alat,       &
                                optCON, optT, optP, opB, opK1K2, opKf, opGAS, optS, lon             ) 
            CASE (8)
    ...
    dh_dx      = (h(2)    - h(1))    / dx
    dpco2_dx   = (pco2(2) - pco2(1)) / dx
    dfco2_dx   = (fco2(2) - fco2(1)) / dx
    dco2_dx    = (co2(2)  - co2(1))  / dx
    dhco3_dx   = (hco3(2) - hco3(1)) / dx
    dco3_dx    = (co3(2)  - co3(1))  / dx
    dOmegaA_dx = (OmegaA(2) - OmegaA(1)) / dx
    dOmegaC_dx = (OmegaC(2) - OmegaC(1)) / dx
