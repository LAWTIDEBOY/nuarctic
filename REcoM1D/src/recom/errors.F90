...
! ENDIF
  ...
  CALL derivnum (dh_dx, dpco2_dx, dfco2_dx, dco2_dx, dhco3_dx,              &
            ...
            temp, sal, alk, dic, sil, phos, Patm, depth, lat, 'alk',     &
  ...
  CALL derivnum (dh_dx, dpco2_dx, dfco2_dx, dco2_dx, dhco3_dx,              &
            dco3_dx, dOmegaA_dx, dOmegaC_dx,                                &
            temp, sal, alk, dic, sil, phos, Patm, depth, lat, 'dic',        &
            optCON, optT, optP, opB, opK1K2, opKf, opGAS                    )
  ...
  IF (esil .ne. 0.0) THEN
      ...
      CALL derivnum (dh_dx, dpco2_dx, dfco2_dx, dco2_dx, dhco3_dx,              &
                dco3_dx, dOmegaA_dx, dOmegaC_dx,                                &
                temp, sal, alk, dic, sil, phos, Patm, depth, lat, 'sil',     &
                optCON, optT, optP, opB, opK1K2, opKf, opGAS                )
  ...
  IF (ephos .ne. 0.0) THEN

      ! Compute sensitivities (partial derivatives)
      CALL derivnum (dh_dx, dpco2_dx, dfco2_dx, dco2_dx, dhco3_dx,              &
                dco3_dx, dOmegaA_dx, dOmegaC_dx,                                &
                temp, sal, alk, dic, sil, phos, Patm, depth, lat, 'pho',     &
                optCON, optT, optP, opB, opK1K2, opKf, opGAS                )
  ...
  IF (etemp .ne. 0.0) THEN
      ...
      CALL derivnum (dh_dx, dpco2_dx, dfco2_dx, dco2_dx, dhco3_dx,              &
                dco3_dx, dOmegaA_dx, dOmegaC_dx,                                &
                temp, sal, alk, dic, sil, phos, Patm, depth, lat, 'tem',     &
                optCON, optT, optP, opB, opK1K2, opKf, opGAS                )
  ...
  IF (esal .ne. 0.0) THEN
      ...
      CALL derivnum (dh_dx, dpco2_dx, dfco2_dx, dco2_dx, dhco3_dx,              &
                dco3_dx, dOmegaA_dx, dOmegaC_dx,                                &
                temp, sal, alk, dic, sil, phos, Patm, depth, lat, 'sal',     &
                optCON, optT, optP, opB, opK1K2, opKf, opGAS                )
  ...
  IF (any (epK_local8 .NE. 0) ) THEN
      ...
      DO i = 1,8
          ...
          IF (epK_local8(i) .ne. 0.0) THEN
              ...
              CALL derivnum (dh_dx, dpco2_dx, dfco2_dx, dco2_dx, dhco3_dx,              &
                        dco3_dx, dOmegaA_dx, dOmegaC_dx,                                &
                        temp, sal, alk, dic, sil, phos, Patm, depth, lat, Kid(i),    &
                        optCON, optT, optP, opB, opK1K2, opKf, opGAS                    )
